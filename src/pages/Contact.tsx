  ...
  return (
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-1 gap-8 lg:gap-16 lg:grid-cols-2">
          {/* Contact Information */}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-sm text-gray-400">Monday-Friday, 9am-5pm PST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-sm text-gray-400">We'll respond within 24 hours</p>
                  </div>
                </div>
              </div>
          ...
          {/* Contact Form */}
          <div className="order-1 lg:order-2 bg-white rounded-xl shadow-sm border border-gray-100">
