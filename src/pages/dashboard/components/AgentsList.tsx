...
import { Edit2, Trash2, Play, Download, BarChart2 } from 'lucide-react';
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex gap-4 text-sm text-gray-500">
                    <span>Requests: {agent.metrics.requests.toLocaleString()}</span>
                    <span>Success Rate: {agent.metrics.successRate}%</span>
                    <span>Avg Response: {agent.metrics.avgResponseTime}ms</span>
                  </div>
                </div>
